    ...
    <div class="overflow-x-hidden">
        <main class="pt-6 px-6">
            ...
            <div class="bg-white rounded-lg shadow-md p-8 my-8">
                ...
                <div class="p-4">
                    <h2 class="text-2xl ">Tambah Tingkat</h2>
                </div>
                <form method="GET" action="{{ url('administrator/data-tingkat/create') }}">
                    <div class="pb-8">
                        <div class="pt-8">
                        ...
                        <div class="md:grid md:grid-cols-2 hover:bg-gray-50 md:space-y-0 px-4 py-2 space-y-1">
                            ...
                            <div class="relative z-0 w-full mb-5">
                                <select type="number" name="grade_number" value=""  class="block appearance-none w-full bg-grey-lighter border border-grey-lighter text-grey-darker py-3 px-4 pr-8 rounded" id="grid-state">
