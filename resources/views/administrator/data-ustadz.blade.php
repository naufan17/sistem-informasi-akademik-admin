    ...
    <div class="overflow-x-hidden">
        <main class="pt-6 px-6">
            ...
            <div class="bg-white rounded-lg shadow-md p-8 my-8">
                ...
                <p class="text-xl pt-8 flex items-center border-b-2">Daftar List Ustadz</p>
                    ...
                    <table class="table-auto bg-white">
                        ...
                        <tbody class="text-gray-700">
                            ...
                            <tr>
                                ...
                                <td class="text-left py-3 px-4">{{ $ustadz->email }}</td>
                                <td class="text-left py-3 px-4">{{ $ustadz->status }}</td>
                                <td>
                                    <div class="flex py-3 px-4">
                                        <div class="w-5 mr-2 transform hover:text-purple-500 hover:scale-110">
                                            <a href="{{ url('administrator/form-update-data-ustadz') }}/{{ $ustadz->name }}">
