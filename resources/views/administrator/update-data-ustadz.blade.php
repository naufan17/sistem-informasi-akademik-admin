                ...
                <form method="GET" action="{{ url('administrator/data-ustadz/update-profile') }}">
                    <div class="pb-8">
                        ...
                        <div class="md:grid md:grid-cols-2 hover:bg-gray-50 md:space-y-0 px-4 py-2 space-y-1">
                            ...
                            <div class="relative z-0 w-full mb-5">
                                <select type="text" name="status" value="{{ $ustadz->status }}" onclick="this.setAttribute('value', this.value);" required autocomplete="email" required class="pt-3 pb-2 px-3 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none z-1 focus:outline-none focus:ring-0 focus:border-black border-gray-200">
