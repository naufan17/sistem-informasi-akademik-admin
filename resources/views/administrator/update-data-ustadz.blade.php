    ...
    <div class="overflow-x-hidden">
        <main class="pt-6 px-6">
            ...
            <div class="bg-white rounded-lg shadow-md p-8 my-8">
                <div class="p-4">
                    <a href="{{ route('administrator.data-ustadz') }}" class="button flex items-center border border-teal-500 text-teal-500 block rounded-sm py-3 px-6 w-32 hover:bg-blue-700 hover:text-white">
                ...
                <form method="GET" action="{{ url('administrator/update-data-ustadz') }}">
                    <div class="pb-8">
                        <div class="pt-8">
                        ...
                        <div class="md:grid md:grid-cols-2 hover:bg-gray-50 md:space-y-0 px-4 py-2 space-y-1">
                            ...
                            <div class="relative z-0 w-full mb-5">
                                <input id="name" type="text" name="name" placeholder="" value="{{ $ustadz->name }}" required autocomplete="name" required class="pt-3 pb-2 px-3 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200" />
                        ...
                        <div class="md:grid md:grid-cols-2 hover:bg-gray-50 md:space-y-0 px-4 py-2 space-y-1">
                            ...
                            <div class="relative z-0 w-full mb-5">
                                <input id="email" type="email" name="email" placeholder="" value="{{ $ustadz->email }}" required autocomplete="email" required class="pt-3 pb-2 px-3 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200" />
                                <span class="text-sm text-red-600 hidden" id="error">This field is required</span>
                            </div>
                        </div>
                        <div class="md:grid md:grid-cols-2 hover:bg-gray-50 md:space-y-0 px-4 py-2 space-y-1">
