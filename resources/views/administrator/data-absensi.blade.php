...
<div class="w-full flex flex-col h-screen overflow-y-hidden">
    <div class="overflow-x-hidden">
        <main class="m:pt-6 pt-3 sm:px-6 px-3">
            <h1 class="sm:text-3xl text-2xl text-black pb-2 mt-2">Absensi</h1>
            <div class="bg-white rounded-lg shadow-md sm:p-8 p-4 sm:my-8 my-4">
                ...
                <p class="sm:text-xl text-lg mb-4 pt-4 flex items-center">Input Presentase Absensi</p>
                    ...
                    <table class="table-auto bg-white">
                        <thead class="bg-gray-800 text-white">
                            <tr>
                                ...
                                <th class="text-center w-1/3 sm:py-3 py-2 sm:px-4 px-3 uppercase font-semibold sm:text-base text-sm">Absensi</td>
                            </tr>
                        </thead>
