                            ...
                            <table class="table-auto bg-white">
                                <thead class="bg-gray-800 text-white">
                                    <tr>
                                        ...
                                        <th class="text-left w-1/5 py-3 px-4 uppercase font-semibold text-sm">Username
                                        </th>
                                        <th class="text-left w-1/5 py-3 px-4 uppercase font-semibold text-sm">Password
                                            </td>
                                ...
                                <tbody class="text-gray-700">
                                    ...
                                    <tr class="bg-gray-200">
                                        ...
                                        <td class="text-left py-3 px-4"><a
                                                href="mailto:adam@gmail.com">adam@gmail.com</a></td>
                                        <td class="text-left py-3 px-4">181060500xx</td>
                                        <td class="text-left py-3 px-4">123xxx</td>
                                        <td>
                                            <div class="flex py-3 px-4">
