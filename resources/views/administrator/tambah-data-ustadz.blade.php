            ...
            <div class="bg-white rounded-lg shadow-md p-8 my-8">
                ...
                <form method="GET" action="{{ url('administrator/data-ustadz/create') }}">
                    <div class="pb-8">
                        ...
                        <input id="role" type="hidden" name="role" placeholder="" value="Ustadz" required autocomplete="role" required class="pt-3 pb-2 px-3 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200" />
                        <div class="md:grid md:grid-cols-2 hover:bg-gray-50 md:space-y-0 px-4 py-2 space-y-1">
