    ...
    <div class="overflow-x-hidden">
        <main class="pt-6 px-6">
            ...
            <div class="bg-white rounded-lg shadow-md p-8 my-8">
                <!-- BACK BUTTON -->
                <div class="p-4">
                    <a href="{{ url('administrator/data-nilai') }}" class="button flex items-center border border-teal-500 text-teal-500 rounded-sm py-3 px-6 w-36 hover:bg-blue-700 hover:text-white">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center py-3 px-4">
                                        <div class="relative z-0 w-full">
                                            ...
                                            <input type="hidden" name="year" placeholder="" value="{{ $cumulativestudy->year }}"  required class="py-2 px-3 block w-full bg-transparent border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-300" />
                                            <input type="hidden" name="semester" placeholder="" value="{{ $cumulativestudy->semester }}"  required class="py-2 px-3 block w-full bg-transparent border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-300" />
                                            ...
                                            <input type="hidden" name="id_santri" placeholder="" value="{{ $cumulativestudy->id_santri }}"  required class="py-2 px-3 block w-full bg-transparent border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-300" />
                                            <input type="hidden" name="id_course" placeholder="" value="{{ $cumulativestudy->id_course }}"  required class="py-2 px-3 block w-full bg-transparent border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-300" />
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
