    ...
    <div class="overflow-x-hidden">
        <main class="m:pt-6 pt-3 sm:px-6 px-3">
            ...
            <div class="bg-white rounded-lg shadow-md sm:p-8 p-4 sm:my-8 my-4">
                ...
                <div class="p-4">
                    <h2 class="sm:text-2xl text-xl">Update Mata Pelajaran</h2>
                </div>
                <form method="POST" action="{{ url('administrator/data-mapel/update') }}">
                    @csrf
                    ...
                    <div class="pb-8">
                        ...
                        <div class="md:grid md:grid-cols-2 hover:bg-gray-50 md:space-y-0 px-4 py-2 space-y-1">
                            ...
                            <div class="relative z-0 w-full mb-5">
                                <input type="text" name="course" value="{{ $course->course }}" required class="sm:text-base text-sm pt-3 pb-2 px-3 block w-full mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200" />
                            </div>
                        </div>
                        <div class="md:grid md:grid-cols-2 hover:bg-gray-50 md:space-y-0 px-4 py-2 space-y-1">
                            <p class="self-center sm:text-base text-sm text-gray-600">Nama Kitab</p>
                            <div class="relative z-0 w-full mb-5">
                                <input type="text" name="book" value="{{ $course->book }}" required class="sm:text-base text-sm pt-3 pb-2 px-3 block w-full mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200" />
                            </div>
                        </div>
                        <div class="md:grid md:grid-cols-2 hover:bg-gray-50 md:space-y-0 px-4 py-2 space-y-1">
                            <p class="self-center sm:text-base text-sm text-gray-600">Status</p>
                            <div class="relative z-0 w-full mb-5">
                                <select type="text" name="status_course" value="{{ $course->status_course }}" required onclick="this.setAttribute('value', this.value);" required class="sm:text-base text-sm pt-3 pb-2 px-3 block w-full mt-0 bg-transparent border-0 border-b-2 appearance-none z-1 focus:outline-none focus:ring-0 focus:border-black border-gray-200">
                        ...
                        <div class="md:grid md:grid-cols-2 hover:bg-gray-50 md:space-y-0 px-4 py-2 space-y-1">
                            ...
                            <div class="relative z-0 w-full mb-5">
                                <select type="number" name="id_grade" value="{{ $course->id_grade }}" required onclick="this.setAttribute('value', this.value);" class="sm:text-base text-sm pt-3 pb-2 px-3 block w-full mt-0 bg-transparent border-0 border-b-2 appearance-none z-1 focus:outline-none focus:ring-0 focus:border-black border-gray-200">
                        ...
                        <div class="md:grid md:grid-cols-2 hover:bg-gray-50 md:space-y-0 px-4 py-2 space-y-1">
                            ...
                            <div class="relative z-0 w-full mb-5">
                                <select type="number" name="id_schedule" value="{{ $course->id_schedule }}" required onclick="this.setAttribute('value', this.value);" class="sm:text-base text-sm pt-3 pb-2 px-3 block w-full mt-0 bg-transparent border-0 border-b-2 appearance-none z-1 focus:outline-none focus:ring-0 focus:border-black border-gray-200">
                        ...
                        <div class="md:grid md:grid-cols-2 hover:bg-gray-50 md:space-y-0 px-4 py-2 space-y-1">
                            ...
                            <div class="relative z-0 w-full mb-5">
                                <select type="number" name="id_ustadz" value="{{ $course->id }}" required onclick="this.setAttribute('value', this.value);" class="sm:text-base text-sm pt-3 pb-2 px-3 block w-full mt-0 bg-transparent border-0 border-b-2 appearance-none z-1 focus:outline-none focus:ring-0 focus:border-black border-gray-200">
                        ...
                        <div class="flex flex-row-reverse">
                            ...
                            <div class="object-left text-center text-white sm:text-base text-sm pt-8 px-3">
                                <a href="{{ url('administrator/data-mapel/delete') }}/{{ $course->id_course }}" type="submit" class="bg-red-600 hover:bg-red-700 rounded py-2.5 sm:px-6 px-3.5">Hapus</a>
                            </div>
                        </div>
                    </div>
                @endforeach
