    ...
    <div class="overflow-x-hidden">
        <main class="sm:pt-6 pt-3 sm:px-6 px-3">
            ...
            <div class="bg-white rounded-lg shadow-md sm:p-8 p-4 sm:my-8 my-4">
                ...
                <div class="p-4">
                    <h2 class="sm:text-2xl text-xl">Tambah Admin
                    </h2>
                </div>
                    ...
                    <div class="pb-4">
                        ...
                        <div class="md:grid md:grid-cols-2 hover:bg-gray-50 sm:text-base text-sm md:space-y-0 px-4 py-2 space-y-1">
                            ...
                            <div class="relative z-0 w-full mb-5">
                                <input type="text" name="name" required class="sm:text-base text-sm pt-3 pb-2 px-3 block w-full mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200" />
                            </div>
                        </div>
                        <div class="md:grid md:grid-cols-2 hover:bg-gray-50 sm:text-base text-sm md:space-y-0 px-4 py-2 space-y-1">
                            <p class="self-center text-gray-600">Username</p>
                            <div class="relative z-0 w-full mb-5">
                                <input type="text" name="username" required class="sm:text-base text-sm pt-3 pb-2 px-3 block w-full mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200" />
                            </div>
                        </div>
                        <div class="md:grid md:grid-cols-2 hover:bg-gray-50 sm:text-base text-sm md:space-y-0 px-4 py-2 space-y-1">
