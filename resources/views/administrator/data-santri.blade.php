                    ...
                    <table class="table-auto bg-white">
                        ...
                        <tbody class="text-gray-700">
                            ...
                            <tr class="bg-gray-200">
                                ...
                                <td class="text-left py-3 px-4"><a>Si John</a></td>
                                <td class="text-left py-3 px-4">1 Wustho</td>
                                <td class="text-left py-3 px-4">Aktif</td>
                                <td>
                                    <div class="flex py-3 px-4">
                                        <div class="w-5 mr-2 transform hover:text-purple-500 hover:scale-110">
                            ...
                            <tr>
                                ...
                                <td class="text-left py-3 px-4"><a>Si John</a></td>
                                <td class="text-left py-3 px-4">2 Wustho</td>
                                <td class="text-left py-3 px-4">Tidak Aktif</td>
                                <td>
                                    <div class="flex py-3 px-4">
                                        <div class="w-5 mr-2 transform hover:text-purple-500 hover:scale-110">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <tr class="bg-gray-200">
                                ...
                                <td class="text-left py-3 px-4"><a>Si John</a></td>
                                <td class="text-left py-3 px-4">1 Ulya</td>
                                <td class="text-left py-3 px-4">Aktif</td>
                                <td>
                                    <div class="flex py-3 px-4">
                                        <div class="w-5 mr-2 transform hover:text-purple-500 hover:scale-110">
