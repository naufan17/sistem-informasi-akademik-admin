    ...
    <div class="overflow-x-hidden">
        <main class="sm:pt-6 pt-3 sm:px-6 px-3">
            ...
            <div class="bg-white rounded-lg shadow-md sm:p-8 p-4 sm:my-8 my-4">
                <div class="p-4">
                    <a href="{{ url('administrator/data-ustadz') }}" class="button flex items-center border border-black-500 text-black-500 rounded-sm py-2.5 sm:px-6 px-3.5 sm:w-36 w-28 hover:bg-blue-700 hover:text-white">
                ...
                <div class="p-4">
                    <h2 class="sm:text-2xl text-xl">Tambah Ustadz</h2>
                </div>
                <form method="POST" action="{{ url('administrator/data-ustadz/import') }}" enctype="multipart/form-data">
                    ...
                    <div class="pb-4">
                        ...
                        <p class="sm:text-base text-sm px-4 py-2">Download template import <a href="{{ url('administrator/data-ustadz/sample-import') }}" class="text-blue-800 underline">disini</a></p>
                    </div>
                </form>
            </div>
        </main>
