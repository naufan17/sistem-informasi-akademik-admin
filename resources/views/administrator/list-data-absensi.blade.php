    ...
    <div class="overflow-x-hidden">
        <main class="pt-6 px-6">
            ...
            <div class="bg-white rounded-lg shadow-md p-8 my-8">
                <!-- BACK BUTTON -->
                <div class="p-4">
                    <a href="{{ url('administrator/data-absensi') }}" class="button flex items-center border border-teal-500 text-teal-500 rounded-sm py-3 px-6 w-36 hover:bg-blue-700 hover:text-white">
                ...
                @foreach($santris as $santri)
                    @if(date('m') <= 06 )
                        @if($santri->year == date('Y') && $santri->semester == 'Genap')
                        @else
                    ...
                    <table class="table-auto bg-white">
                        ...
                        <tbody class="text-gray-700">
                            ...
                            <tr>
                                ...
                                <td class="text-center py-3 px-4">{{ $santri->attendance_mdnu }}</td>
                                <td class="text-center py-3 px-4">{{ $santri->attendance_asrama }}</td>
                                <td>
