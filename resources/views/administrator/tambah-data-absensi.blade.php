    ...
    <div class="overflow-x-hidden">
        <main class="m:pt-6 pt-3 sm:px-6 px-3">
            ...
            <div class="bg-white rounded-lg shadow-md sm:p-8 p-4 sm:my-8 my-4">
                <div class="p-4">
                    <a href="{{ url('administrator/data-absensi/list') }}/{{ $idSantri }}" class="button flex items-center border border-black-500 text-black-500 sm:text-base text-sm rounded-sm py-2.5 sm:px-6 px-3.5 sm:w-36 w-28 hover:bg-blue-700 hover:text-white">
                ...
                <div class="p-4">
                    <h2 class="sm:text-2xl text-xl">Tambah Absensi</h2>
                </div>
                <form method="POST" action="{{ url('administrator/data-absensi/create') }}">
                    ...
                    <div class="pb-8">
                        ...
                        @endif
                        <div class="md:grid md:grid-cols-2 hover:bg-gray-50 md:space-y-0 px-4 py-2 space-y-1">
                            <p class="self-center sm:text-base text-sm text-gray-600">Presentase Absensi MDNU</p>
                            <div class="relative z-0 w-full mb-5">
                                <input type="number" name="attendance_mdnu" placeholder="1-100%" min="0" max="100" required class="sm:text-base text-sm pt-3 pb-2 px-3 block w-full mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200" />
                            </div>
                        </div>
                        <div class="md:grid md:grid-cols-2 hover:bg-gray-50 md:space-y-0 px-4 py-2 space-y-1">
                            <p class="self-center sm:text-base text-sm text-gray-600">Presentase  Absensi Asrama</p>
                            <div class="relative z-0 w-full mb-5">
