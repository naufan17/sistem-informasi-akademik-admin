    ...
    <div class="overflow-x-hidden">
        <main class="pt-6 px-6">
            ...
            <div class="bg-white rounded-lg shadow-md p-8 my-8">
                <div class="p-4">
                    <a href="{{ url('administrator/data-tingkat') }}" class="button flex items-center border border-teal-500 text-teal-500 block rounded-sm py-3 px-6 w-32 hover:bg-blue-700 hover:text-white">
                ...
                <div class="p-4">
                    <h2 class="text-2xl ">Update Tingkat</h2>
                </div>
                <form method="GET" action="{{ url('administrator/data-tingkat/update') }}">
                    <div class="pb-8">
                        <div class="pt-8">
                            <p class="self-center bg-gray-50 py-4 px-4">Tingkatan Kelas</p>
                        </div>
                        @foreach($grades as $grade)
                        <input type="hidden" name="id_grade" value="{{ $grade->id_grade }}" placeholder="" required autocomplete="id_grade" required class="pt-3 pb-2 px-3 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200" />
